...
# -------------- 训练函数 --------------
def train_model(root, sequence_length=50, batch_size=32, num_epochs=10, learning_rate=0.001):
    ...
    # 保存模型
    torch.save(model.state_dict(), "lstm_model_npz.pth")
    print("Model saved!")


# -------------- 运行训练 --------------
if __name__ == "__main__":
    root = "./newdata/"  # .npz 文件夹路径
    train_model(root, sequence_length=101, batch_size=32, num_epochs=50, learning_rate=0.001)
